...
//
// DESCRIPTION:
//      All external data is defined here. Most of the data is
//      loaded into different structures at run time. Some
//      internal structures shared by many modules are here.
